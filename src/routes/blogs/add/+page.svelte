<script lang="ts">
	...
	// Get form data for feedback messages
	let { form } = $props();
...
<form method="POST" enctype="multipart/form-data" use:enhance>
    ...
    <textarea name="summary" placeholder="Summary" bind:value={summary} required></textarea>
    ...
    <button type="submit" class="save-button" formaction="?/save">Save Blog Post</button>
</form>
